...
export default function QuizCreate() {
  ...
  async function handleSubmit(e?: React.FormEvent) {
    ...
    try {
      ...
      if (!questionId) {
        console.warn("The server response did not return a question ID", qResp);
      }
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full rounded-lg border border-gray-200 px-4 py-3 text-background placeholder-gray-400 focus:ring-2 focus:ring-violet-200 focus:outline-none"
