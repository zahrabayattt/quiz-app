  ...
  return (
    <div className="flex items-start gap-3">
      <input
        ...
        className="flex-1 rounded-md border border-gray-200 px-4 py-3 text-background placeholder-gray-400 focus:ring-2 focus:ring-violet-300 focus:outline-none"
        {...rest}
      />
      {onRemove && (
        <button
